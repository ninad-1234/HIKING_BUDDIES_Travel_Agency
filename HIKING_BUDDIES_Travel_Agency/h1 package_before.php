...
<body>
<div class="arrow">
        <font size=3 align='center'><a href="h package_before.php"><img src="arrow.jpg" height="20px" width="20px"/></a></font></button>    
    </div>
...
if($row['name']==$name )
{
    ...
    <a href="i clogin.html">
              <button type="button" class="Logout-btn" id="logout">Login</button>
            </a>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <a href="k1 package_after.php?city_n=Australia">
                            <button type="submit" class="booking-btn" id="book">Book Now</button></a>
                            </form>
                        </div>
                        <div class="insurance">
                            <h4>Just Login and Get the Package !!</h4>
